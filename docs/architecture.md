...
- `engine/gbrain_remote_mcp_health.mjs`: optional GBrain Remote MCP smoke test
- `engine/gbrain_remote_mcp_http_server.mjs`: host-side HTTP MCP wrapper for
  the cloud memory center
